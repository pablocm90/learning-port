...
ActiveRecord::Schema[8.0].define(version: 2026_02_03_132511) do
  ...
  create_table "learning_moments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_learning_moments_on_category_id"
  end
  ...
  create_table "podcast_categories", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_podcast_categories_on_slug", unique: true
  end
